...
void print_head(struct sf_header head);
sf_header setheader(sf_header h, int i);
void pll();
sf_header free_head(sf_header head);
void* best_fit_equal();
void* best_fit_less();
void coalescing();
...
bool check_valid_free(void* h);
bool check_valid_bounds(void* h);
